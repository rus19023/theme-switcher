...
ts = quick_theme_setup(default_theme='neon')

# Now build your app normally
st.title("🎨 Modular Theme Demo v2")
st.markdown("### Switch themes in the sidebar!")
...
# Tabs
tab1, tab2, tab3 = st.tabs(["Overview", "Settings", "Documentation"])
...
# That's it! Your app now has themes
    ...
    with col2:
        ...
        for theme_key, theme_data in ts.THEMES.items():
